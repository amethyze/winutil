...
echo  WinUtil - Windows MultiUtilities v1.7
...
:w8
title ...
echo This option is now deprecated. Sorry for the
echo inconvenience. Press anything to go back.
pause >nul
goto start
