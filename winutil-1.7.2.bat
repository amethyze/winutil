...
if /i %PRERELEASE%==y (set winutilversion=%STARTUPWINUTILVERSION%)
(
echo %NEEDADMIN%
echo 0
echo %FIRSTTIME%
...
:w8delete
@echo on
if exist %APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\reminders.bat (goto w8deleteyes)
echo You haven't setup any reminders. Press anything
echo to go back to the Startup Reminders menu.
pause>nul
goto w8
